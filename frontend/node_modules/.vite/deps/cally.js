...
var se = class {
   ...
   */
  set current(t) {
    __privateGet(this, _t) != t && (__privateSet(this, _t, t), __privateGet(this, _e).forEach((n) => n(t)));
  }
  /**
...
var st = (e, t) => (t ? e instanceof HTMLStyleElement : true) && "hydrate" in ((e == null ? void 0 : e.dataset) || {});
function Ut(e, t) {
  let n;
  const s = (r) => {
    let { length: o } = r;
...
var jt = class extends _t2 {
};
var le = class extends _t2 {
};
var x = "Custom";
var ue = null;
var fe = { true: 1, "": 1, 1: 1 };
function de(e, t, n, s, r) {
  const {
    ...
    value: i,
    attr: l = he(t)
  } = (n == null ? void 0 : n.name) != x && R(n) && n != ue ? n : { type: n }, c = (o == null ? void 0 : o.name) === x && o.map, d = i != null ? o == Function || !T(i) ? () => i : i : null;
...
var me = (e, t, n, s) => s == null || t == Boolean && !s ? e.removeAttribute(n) : e.setAttribute(
  n,
  (t == null ? void 0 : t.name) === x && (t == null ? void 0 : t.serialize) ? t == null ? void 0 : t.serialize(s) : R(s) ? JSON.stringify(s) : t == Boolean ? "" : s
);
...
function N(e) {
  const [t, n] = it(e);
  return [C(() => z(v, t), [t]), (o) => n(o == null ? void 0 : o.toString())];
}
function Be(e) {
  const [t = "", n] = it(e);
  return [C(() => {
...
function Ke({ props: e, context: t }) {
  ...
  function ee(b) {
    ...
    if (!t.showOutsideDays && !D)
      return;
    const ne = b.equals(c), bt = b.equals(f), Y = w(b), B = r == null ? void 0 : r(Y), gt = !Pt(b, o, a);
    let vt = "", k;
    if (t.type === "range") {
      const [F, Z] = t.value, Et = F == null ? void 0 : F.equals(b), Dt = Z == null ? void 0 : Z.equals(b);
      k = F && Z && Pt(b, F, Z), vt = `${Et ? "range-start" : ""} ${Dt ? "range-end" : ""} ${k && !Et && !Dt ? "range-inner" : ""}`;
    } else
      t.type === "multi" ? k = t.value.some((F) => F.equals(b)) : k = (_a = t.value) == null ? void 0 : _a.equals(b);
    return {
      part: `${`button day day-${Y.getDay()} ${// we don't want outside days to ever be shown as selected
      D ? k ? "selected" : "" : "outside"} ${B ? "disallowed" : ""} ${bt ? "today" : ""} ${((_b = t.getDayParts) == null ? void 0 : _b.call(t, Y)) ?? ""}`} ${vt}`,
      tabindex: D && ne ? 0 : -1,
      disabled: gt,
...
var Je = j(
  (e) => {
    ...
    function r() {
      var _a;
      (_a = n.current.querySelector("button[tabindex='0']")) == null ? void 0 : _a.focus();
    }
...
function yt({
  ...
  function y(h) {
    const S = (h == null ? void 0 : h.target) ?? "day";
